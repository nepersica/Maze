...
#include <FL\Fl_Box.H>				// Outbox
#include <FL\Fl_Check_Button.H>		// Check Button 헤더
#include <FL\Fl_Multiline_Output.H>	// 줄바꿈 헤더
...
void CheckButton::attach(Window &win)
{
	//Random_button(510, 110, 40, 30, "Random")
